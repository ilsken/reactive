...
/**
 * Interpolation control regex.
 */

var interpolReg = /\{([^}]+)\}/g;

/**
 * Interpolation character for detection.
 */
...
exports.interpolate = function(str, fn){
  return str.replace(interpolReg, function(_, expr){
    var cb = cache[expr];
...
exports.hasInterpolation = function(str) {
  return ~str.indexOf(interpolChar);
};
